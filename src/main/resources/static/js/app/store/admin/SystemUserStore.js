Ext.define('app.store.admin.SystemUserStore', {
    ...
    restePassword:function(user){
        ...
        app.ux.Utils.ajaxRequest({
            url: webRoot +'/admin/systemUsers/resetPassword.handler?userId='+user.get('userId'),
    ...
    startUser: function (user) {
        var me = this;        
        app.ux.Utils.ajaxRequest({
            url: webRoot +'/admin/systemUsers/enableUser.handler?userId='+user.get('userId'),
            successCallback:function(record,response,opts){
                user.beginEdit();
    ...
    stopUser:function(user){
        var me = this;        
        app.ux.Utils.ajaxRequest({
            url: webRoot +'/admin/systemUsers/disableUser.handler?userId='+user.get('userId'),
            successCallback:function(record,response,opts){
                user.beginEdit();
    ...
    getUserRoles:function(user){
        ...
        app.ux.Utils.ajaxRequest({
            url:webRoot+'/admin/systemUsers/getUserRoles.handler?userId='+user.get('userId'),        
